...
#define CONF_HELPER_BUF_LEN			128
#define CONF_MAX_RESOURCES			16
#define CONF_MAX_RESOURCE_QUERIES	3
#define CONF_MAX_OBSERVERS			2
#define CONF_MAX_MSG_LEN			192
#define CONF_MAX_PAYLOAD_LEN		160
#define CONF_PIGGY_BACKED			1
#define CONF_MAX_RETRANSMIT_SLOTS	1
